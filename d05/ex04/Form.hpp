...
protected:
	...
	public:
		...
		FormNotSignedException(FormNotSignedException const& e);
		~FormNotSignedException(void) _NOEXCEPT;

		FormNotSignedException& operator=(FormNotSignedException const& e);
